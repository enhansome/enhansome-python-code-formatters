...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,233 | 🐛 2,101 | 🌐 Rust | 📅 2026-08-17: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,804 | 🐛 307 | 🌐 Python | 📅 2026-08-17: uncompromising Python code formatter.
...
* [isort](https://github.com/timothycrosley/isort) ⭐ 6,949 | 🐛 91 | 🌐 Python | 📅 2026-08-16: sorts imports.
...
* [pyupgrade](https://github.com/asottile/pyupgrade) ⭐ 4,112 | 🐛 21 | 🌐 Python | 📅 2026-08-16: upgrades syntax for newer versions of the language.
* [django-upgrade](https://github.com/adamchainz/django-upgrade) ⭐ 1,228 | 🐛 8 | 🌐 Python | 📅 2026-08-17: upgrades Django projects.
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 189 | 🐛 8 | 🌐 Python | 📅 2026-08-17: upgrades Django projects to newer version of the framework by automatically fixing deprecations.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,265 | 🐛 891 | 🌐 OCaml | 📅 2026-08-17: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
...
* [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing#helper-tools-to-add-annotations-to-existing-code) ⭐ 1,977 | 🐛 7 | 📅 2026-06-19: tools to generate type annotations.
