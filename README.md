...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,413 | 🐛 2,163 | 🌐 Rust | 📅 2026-08-31: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,827 | 🐛 311 | 🌐 Python | 📅 2026-08-31: uncompromising Python code formatter.
...
* [pydocstringformatter](https://github.com/DanielNoord/pydocstringformatter) ⭐ 90 | 🐛 15 | 🌐 Python | 📅 2026-08-31: Automatically format your Python docstrings to conform with PEP 8 and PEP 257.
* [no-optional](https://github.com/Kludex/no-optional) ⭐ 57 | 🐛 4 | 🌐 Python | 📅 2026-05-01: Replace `Optional[T]` by `Union[T, None]`.
* [docstrfmt](https://github.com/LilSpazJoekp/docstrfmt) ⭐ 44 | 🐛 11 | 🌐 Python | 📅 2026-08-31: a tool for automatically formatting reStructuredText in files and Python docstrings in a consistent way.
...
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 190 | 🐛 8 | 🌐 Python | 📅 2026-08-31: upgrades Django projects to newer version of the framework by automatically fixing deprecations.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,457 | 🐛 906 | 🌐 OCaml | 📅 2026-08-31: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
...
* [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing#helper-tools-to-add-annotations-to-existing-code) ⭐ 1,981 | 🐛 7 | 📅 2026-06-19: tools to generate type annotations.
