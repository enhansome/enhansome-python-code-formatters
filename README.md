...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,256 | 🐛 2,119 | 🌐 Rust | 📅 2026-08-19: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,809 | 🐛 297 | 🌐 Python | 📅 2026-08-19: uncompromising Python code formatter.
...
* [reorder-python-imports](https://github.com/asottile/reorder_python_imports) ⭐ 784 | 🐛 2 | 🌐 Python | 📅 2026-08-19: reorders imports.
...
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 189 | 🐛 8 | 🌐 Python | 📅 2026-08-19: upgrades Django projects to newer version of the framework by automatically fixing deprecations.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,305 | 🐛 891 | 🌐 OCaml | 📅 2026-08-19: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
