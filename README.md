...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,342 | 🐛 2,157 | 🌐 Rust | 📅 2026-08-26: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,816 | 🐛 303 | 🌐 Python | 📅 2026-08-20: uncompromising Python code formatter.
* [yapf](https://github.com/google/yapf) ⭐ 13,980 | 🐛 417 | 🌐 Python | 📅 2026-08-21: yet another Python code formatter from Google.
...
* [isort](https://github.com/timothycrosley/isort) ⭐ 6,947 | 🐛 82 | 🌐 Python | 📅 2026-08-26: sorts imports.
...
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 190 | 🐛 9 | 🌐 Python | 📅 2026-08-26: upgrades Django projects to newer version of the framework by automatically fixing deprecations.
...
* [nbQA](https://github.com/nbQA-dev/nbQA) ⭐ 1,204 | 🐛 22 | 🌐 Python | 📅 2026-08-24: run `isort`, `pyupgrade`, `mypy`, `pylint`, `flake8`, and more on Jupyter Notebooks.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,409 | 🐛 901 | 🌐 OCaml | 📅 2026-08-26: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
...
* [rope](https://github.com/python-rope/rope) ⭐ 2,234 | 🐛 142 | 🌐 Python | 📅 2026-08-25: refactoring library.
...
* [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing#helper-tools-to-add-annotations-to-existing-code) ⭐ 1,980 | 🐛 7 | 📅 2026-06-19: tools to generate type annotations.
* [awesome-python-testing](https://github.com/cleder/awesome-python-testing#tools) ⭐ 307 | 🐛 1 | 📅 2026-08-26: tools to generate tests.
