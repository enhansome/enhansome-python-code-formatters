...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,288 | 🐛 2,143 | 🌐 Rust | 📅 2026-08-23: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,816 | 🐛 302 | 🌐 Python | 📅 2026-08-20: uncompromising Python code formatter.
* [yapf](https://github.com/google/yapf) ⭐ 13,979 | 🐛 419 | 🌐 Python | 📅 2026-08-21: yet another Python code formatter from Google.
...
* [isort](https://github.com/timothycrosley/isort) ⭐ 6,947 | 🐛 88 | 🌐 Python | 📅 2026-08-18: sorts imports.
* [autoflake](https://github.com/myint/autoflake) ⭐ 952 | 🐛 41 | 🌐 Python | 📅 2026-08-23: removes unused imports and unused variables as reported by pyflakes.
...
* [django-upgrade](https://github.com/adamchainz/django-upgrade) ⭐ 1,231 | 🐛 10 | 🌐 Python | 📅 2026-08-18: upgrades Django projects.
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 189 | 🐛 8 | 🌐 Python | 📅 2026-08-22: upgrades Django projects to newer version of the framework by automatically fixing deprecations.
* [com2ann](https://github.com/ilevkivskyi/com2ann) ⭐ 158 | 🐛 10 | 🌐 Python | 📅 2025-06-02: translates type comments to type annotations.
* [auto-walrus](https://github.com/MarcoGorelli/auto-walrus) ⭐ 130 | 🐛 4 | 🌐 Python | 📅 2026-08-17: automatically use the walrus operator where possible.
...
* [nbQA](https://github.com/nbQA-dev/nbQA) ⭐ 1,203 | 🐛 22 | 🌐 Python | 📅 2026-08-22: run `isort`, `pyupgrade`, `mypy`, `pylint`, `flake8`, and more on Jupyter Notebooks.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,364 | 🐛 895 | 🌐 OCaml | 📅 2026-08-21: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
...
* [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing#helper-tools-to-add-annotations-to-existing-code) ⭐ 1,978 | 🐛 7 | 📅 2026-06-19: tools to generate type annotations.
* [awesome-python-testing](https://github.com/cleder/awesome-python-testing#tools) ⭐ 305 | 🐛 0 | 📅 2026-08-23: tools to generate tests.
