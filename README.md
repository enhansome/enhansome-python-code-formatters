...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,788 | 🐛 2,185 | 🌐 Rust | 📅 2026-09-25: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,852 | 🐛 285 | 🌐 Python | 📅 2026-09-24: uncompromising Python code formatter.
* [yapf](https://github.com/google/yapf) ⭐ 13,986 | 🐛 425 | 🌐 Python | 📅 2026-09-25: yet another Python code formatter from Google.
...
* [docformatter](https://github.com/PyCQA/docformatter) ⭐ 598 | 🐛 41 | 🌐 Python | 📅 2026-08-10: formats docstrings to follow PEP 257.
...
* [unify](https://github.com/myint/unify) ⭐ 99 | 🐛 16 | 🌐 Python | 📅 2022-07-04: modifies strings to all use the same quote where possible.
...
* [docstrfmt](https://github.com/LilSpazJoekp/docstrfmt) ⭐ 44 | 🐛 8 | 🌐 Python | 📅 2026-09-21: a tool for automatically formatting reStructuredText in files and Python docstrings in a consistent way.
...
* [pydocformatter](https://github.com/pallgeuer/pydocformatter) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-23: rule-based formatter and linter for Python docstrings and comments.
...
* [isort](https://github.com/timothycrosley/isort) ⭐ 6,953 | 🐛 80 | 🌐 Python | 📅 2026-09-25: sorts imports.
...
* [unimport](https://github.com/hakancelik96/unimport) ⭐ 248 | 🐛 19 | 🌐 Python | 📅 2026-09-25: removes unused imports.
...
* [pyall](https://github.com/hakancelik96/pyall) ⭐ 24 | 🐛 20 | 🌐 Python | 📅 2026-09-25: keeps the `__all__` list always up to date.
...
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 189 | 🐛 8 | 🌐 Python | 📅 2026-09-25: upgrades Django projects to newer version of the framework by automatically fixing deprecations.
...
* [nbQA](https://github.com/nbQA-dev/nbQA) ⭐ 1,206 | 🐛 22 | 🌐 Python | 📅 2026-08-31: run `isort`, `pyupgrade`, `mypy`, `pylint`, `flake8`, and more on Jupyter Notebooks.
...
* [blacken-docs](https://github.com/asottile/blacken-docs) ⭐ 679 | 🐛 17 | 🌐 Python | 📅 2026-09-08: runs `black` on python code blocks in documentation files.
...
* [mdsf](https://github.com/hougesen/mdsf) ⭐ 113 | 🐛 41 | 🌐 Rust | 📅 2026-09-01: run python formatters on markdown code blocks.
* [pyformat](https://github.com/myint/pyformat) ⭐ 92 | 🐛 9 | 🌐 Python | 📅 2024-01-01: wrapper around `autopep8`, `autoflake`, `docformatter`, and `unify`.
* [black-macchiato](https://github.com/wbolster/black-macchiato) ⭐ 73 | 🐛 7 | 🌐 Python | 📅 2025-04-26: runs `black` on parts of the code.
...
* [formate-black](https://github.com/python-formate/formate-black) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-13: integrates `black` with `formate`.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,761 | 🐛 932 | 🌐 C | 📅 2026-09-25: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
* [comby](https://github.com/comby-tools/comby) ⭐ 2,677 | 🐛 86 | 🌐 OCaml | 📅 2026-06-08: Comby is a tool for searching and changing code structure
* [rope](https://github.com/python-rope/rope) ⭐ 2,239 | 🐛 155 | 🌐 Python | 📅 2026-09-15: refactoring library.
* [libcst](https://github.com/Instagram/LibCST) ⭐ 1,950 | 🐛 173 | 🌐 Python | 📅 2026-08-11: parses Python code as a CST tree that keeps all formatting details (comments, whitespaces, parentheses, etc).
...
* [awesome-python-testing](https://github.com/cleder/awesome-python-testing#tools) ⭐ 310 | 🐛 2 | 📅 2026-09-23: tools to generate tests.
