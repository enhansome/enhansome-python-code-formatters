...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,385 | 🐛 2,155 | 🌐 Rust | 📅 2026-08-29: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,821 | 🐛 304 | 🌐 Python | 📅 2026-08-20: uncompromising Python code formatter.
...
* [docstrfmt](https://github.com/LilSpazJoekp/docstrfmt) ⭐ 44 | 🐛 10 | 🌐 Python | 📅 2026-08-29: a tool for automatically formatting reStructuredText in files and Python docstrings in a consistent way.
...
* [isort](https://github.com/timothycrosley/isort) ⭐ 6,949 | 🐛 85 | 🌐 Python | 📅 2026-08-27: sorts imports.
...
* [mdsf](https://github.com/hougesen/mdsf) ⭐ 111 | 🐛 35 | 🌐 Rust | 📅 2026-08-14: run python formatters on markdown code blocks.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,439 | 🐛 905 | 🌐 OCaml | 📅 2026-08-28: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
...
* [awesome-python-testing](https://github.com/cleder/awesome-python-testing#tools) ⭐ 307 | 🐛 3 | 📅 2026-08-26: tools to generate tests.
