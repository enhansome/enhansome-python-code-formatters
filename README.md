...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,721 | 🐛 2,196 | 🌐 Rust | 📅 2026-09-21: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,849 | 🐛 302 | 🌐 Python | 📅 2026-09-21: uncompromising Python code formatter.
...
* [isort](https://github.com/timothycrosley/isort) ⭐ 6,953 | 🐛 82 | 🌐 Python | 📅 2026-09-21: sorts imports.
* [autoflake](https://github.com/myint/autoflake) ⭐ 953 | 🐛 44 | 🌐 Python | 📅 2026-08-23: removes unused imports and unused variables as reported by pyflakes.
...
* [pyupgrade](https://github.com/asottile/pyupgrade) ⭐ 4,111 | 🐛 23 | 🌐 Python | 📅 2026-09-04: upgrades syntax for newer versions of the language.
* [django-upgrade](https://github.com/adamchainz/django-upgrade) ⭐ 1,246 | 🐛 10 | 🌐 Python | 📅 2026-09-08: upgrades Django projects.
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 190 | 🐛 8 | 🌐 Python | 📅 2026-09-21: upgrades Django projects to newer version of the framework by automatically fixing deprecations.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,715 | 🐛 923 | 🌐 C | 📅 2026-09-21: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
...
* [libcst](https://github.com/Instagram/LibCST) ⭐ 1,947 | 🐛 173 | 🌐 Python | 📅 2026-08-11: parses Python code as a CST tree that keeps all formatting details (comments, whitespaces, parentheses, etc).
...
* [awesome-python-testing](https://github.com/cleder/awesome-python-testing#tools) ⭐ 308 | 🐛 1 | 📅 2026-09-21: tools to generate tests.
