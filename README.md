...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,271 | 🐛 2,125 | 🌐 Rust | 📅 2026-08-20: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,814 | 🐛 299 | 🌐 Python | 📅 2026-08-20: uncompromising Python code formatter.
...
* [docformatter](https://github.com/PyCQA/docformatter) ⭐ 596 | 🐛 36 | 🌐 Python | 📅 2026-08-10: formats docstrings to follow PEP 257.
...
* [pyupgrade](https://github.com/asottile/pyupgrade) ⭐ 4,114 | 🐛 21 | 🌐 Python | 📅 2026-08-20: upgrades syntax for newer versions of the language.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,319 | 🐛 891 | 🌐 OCaml | 📅 2026-08-20: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
