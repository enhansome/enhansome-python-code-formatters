...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,733 | 🐛 2,198 | 🌐 Rust | 📅 2026-09-22: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,848 | 🐛 296 | 🌐 Python | 📅 2026-09-22: uncompromising Python code formatter.
...
* [isort](https://github.com/timothycrosley/isort) ⭐ 6,953 | 🐛 81 | 🌐 Python | 📅 2026-09-22: sorts imports.
* [autoflake](https://github.com/myint/autoflake) ⭐ 953 | 🐛 45 | 🌐 Python | 📅 2026-08-23: removes unused imports and unused variables as reported by pyflakes.
...
* [pyall](https://github.com/hakancelik96/pyall) ⭐ 24 | 🐛 10 | 🌐 Python | 📅 2026-09-20: keeps the `__all__` list always up to date.
...
* [django-upgrade](https://github.com/adamchainz/django-upgrade) ⭐ 1,247 | 🐛 10 | 🌐 Python | 📅 2026-09-08: upgrades Django projects.
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 190 | 🐛 9 | 🌐 Python | 📅 2026-09-22: upgrades Django projects to newer version of the framework by automatically fixing deprecations.
...
* [nbQA](https://github.com/nbQA-dev/nbQA) ⭐ 1,205 | 🐛 22 | 🌐 Python | 📅 2026-08-31: run `isort`, `pyupgrade`, `mypy`, `pylint`, `flake8`, and more on Jupyter Notebooks.
...
* [blacken-docs](https://github.com/asottile/blacken-docs) ⭐ 679 | 🐛 16 | 🌐 Python | 📅 2026-09-08: runs `black` on python code blocks in documentation files.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,726 | 🐛 922 | 🌐 C | 📅 2026-09-22: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
...
* [libcst](https://github.com/Instagram/LibCST) ⭐ 1,948 | 🐛 173 | 🌐 Python | 📅 2026-08-11: parses Python code as a CST tree that keeps all formatting details (comments, whitespaces, parentheses, etc).
...
* [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing#helper-tools-to-add-annotations-to-existing-code) ⭐ 1,985 | 🐛 7 | 📅 2026-09-03: tools to generate type annotations.
* [awesome-python-testing](https://github.com/cleder/awesome-python-testing#tools) ⭐ 309 | 🐛 0 | 📅 2026-09-22: tools to generate tests.
