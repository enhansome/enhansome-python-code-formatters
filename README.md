...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,351 | 🐛 2,158 | 🌐 Rust | 📅 2026-08-27: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,818 | 🐛 302 | 🌐 Python | 📅 2026-08-20: uncompromising Python code formatter.
* [yapf](https://github.com/google/yapf) ⭐ 13,981 | 🐛 417 | 🌐 Python | 📅 2026-08-21: yet another Python code formatter from Google.
...
* [isort](https://github.com/timothycrosley/isort) ⭐ 6,947 | 🐛 84 | 🌐 Python | 📅 2026-08-27: sorts imports.
...
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 190 | 🐛 11 | 🌐 Python | 📅 2026-08-27: upgrades Django projects to newer version of the framework by automatically fixing deprecations.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,416 | 🐛 902 | 🌐 OCaml | 📅 2026-08-27: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
