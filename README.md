...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,430 | 🐛 2,167 | 🌐 Rust | 📅 2026-09-01: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,829 | 🐛 316 | 🌐 Python | 📅 2026-09-01: uncompromising Python code formatter.
...
* [docstrfmt](https://github.com/LilSpazJoekp/docstrfmt) ⭐ 44 | 🐛 11 | 🌐 Python | 📅 2026-09-01: a tool for automatically formatting reStructuredText in files and Python docstrings in a consistent way.
...
* [isort](https://github.com/timothycrosley/isort) ⭐ 6,949 | 🐛 86 | 🌐 Python | 📅 2026-08-27: sorts imports.
...
* [pyupgrade](https://github.com/asottile/pyupgrade) ⭐ 4,113 | 🐛 23 | 🌐 Python | 📅 2026-09-01: upgrades syntax for newer versions of the language.
* [django-upgrade](https://github.com/adamchainz/django-upgrade) ⭐ 1,235 | 🐛 10 | 🌐 Python | 📅 2026-08-28: upgrades Django projects.
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 190 | 🐛 8 | 🌐 Python | 📅 2026-09-01: upgrades Django projects to newer version of the framework by automatically fixing deprecations.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,467 | 🐛 910 | 🌐 OCaml | 📅 2026-09-01: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
