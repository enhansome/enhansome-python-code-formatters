...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,398 | 🐛 2,159 | 🌐 Rust | 📅 2026-08-30: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,821 | 🐛 308 | 🌐 Python | 📅 2026-08-20: uncompromising Python code formatter.
...
* [docstrfmt](https://github.com/LilSpazJoekp/docstrfmt) ⭐ 44 | 🐛 10 | 🌐 Python | 📅 2026-08-30: a tool for automatically formatting reStructuredText in files and Python docstrings in a consistent way.
...
* [auto-walrus](https://github.com/MarcoGorelli/auto-walrus) ⭐ 131 | 🐛 4 | 🌐 Python | 📅 2026-08-24: automatically use the walrus operator where possible.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,447 | 🐛 905 | 🌐 OCaml | 📅 2026-08-28: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
...
* [rope](https://github.com/python-rope/rope) ⭐ 2,234 | 🐛 143 | 🌐 Python | 📅 2026-08-25: refactoring library.
