...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,565 | 🐛 2,186 | 🌐 Rust | 📅 2026-09-09: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,836 | 🐛 310 | 🌐 Python | 📅 2026-09-04: uncompromising Python code formatter.
...
* [isort](https://github.com/timothycrosley/isort) ⭐ 6,952 | 🐛 93 | 🌐 Python | 📅 2026-08-27: sorts imports.
...
* [django-upgrade](https://github.com/adamchainz/django-upgrade) ⭐ 1,241 | 🐛 10 | 🌐 Python | 📅 2026-09-08: upgrades Django projects.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,568 | 🐛 908 | 🌐 OCaml | 📅 2026-09-04: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
...
* [awesome-python-testing](https://github.com/cleder/awesome-python-testing#tools) ⭐ 308 | 🐛 1 | 📅 2026-09-07: tools to generate tests.
