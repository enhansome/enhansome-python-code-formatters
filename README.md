...
* [ruff](https://github.com/astral-sh/ruff) ⭐ 49,362 | 🐛 2,164 | 🌐 Rust | 📅 2026-08-28: fast Rust-powered linter and code formatter, for Python. The formatter is 100% compatible with Black.
* [black](https://github.com/python/black) ⭐ 41,818 | 🐛 303 | 🌐 Python | 📅 2026-08-20: uncompromising Python code formatter.
...
* [django-upgrade](https://github.com/adamchainz/django-upgrade) ⭐ 1,233 | 🐛 10 | 🌐 Python | 📅 2026-08-18: upgrades Django projects.
* [django-codemod](https://github.com/browniebroke/django-codemod) ⭐ 190 | 🐛 11 | 🌐 Python | 📅 2026-08-28: upgrades Django projects to newer version of the framework by automatically fixing deprecations.
...
* [semgrep](https://github.com/returntocorp/semgrep) ⭐ 16,420 | 🐛 903 | 🌐 OCaml | 📅 2026-08-28: like grep but for code. Supports [--autofix](https://semgrep.dev/docs/writing-rules/rule-syntax/#fix) flag for simple replacement of matched code.
